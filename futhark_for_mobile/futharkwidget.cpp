...
void FutharkWidget::paintEvent(QPaintEvent *event)
{
    QPainter painter(this);
        ...
        // https://cpp.hotexamples.com/examples/-/QBrush/-/cpp-qbrush-class-examples.html
        QPixmap pixmapBG(":/futhark2.jpg"); // Load an image
        //pixmapBG.
        QBrush patternBrush(pixmapBG);
        // Create a brush with pattern fill
        //painter.setBrush(patternBrush);
        //painter.setPen(Qt::SolidLine);
        painter.fillRect(event->rect(),patternBrush);

    //painter.fillRect(event->rect(), );
    //painter.fillRect(event->rect(), QBrush(Qt::yellow, Qt::SolidPattern) );// Qt::white);
